...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        <div class="admin-info">
            @if ($admin)
                <img src="{{ $admin->avatar ? asset('storage/avatars/'.$admin->avatar) : asset('images/avatar/default.jpg') }}"
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ route('admin.tongquat.index') }}" class="{{ request()->routeIs('admin.tongquat.index') ? 'active' : '' }}">
                <i class="fa-solid fa-chart-line"></i> Tổng quan admin
            </a></li>
            <li><a href="{{ route('admin.danhmuc.index') }}" class="{{ request()->routeIs('admin.danhmuc.index') ? 'active' : '' }}">
                <i class="fa-solid fa-list"></i> Quản lý Danh mục
            </a></li>
            <li><a href="{{ route('admin.tours.index') }}" class="{{ request()->routeIs('admin.tours.*') ? 'active' : '' }}">
            ...
            <li><a href="{{ route('admin.nguoidung.index') }}" class="{{ request()->routeIs('admin.nguoidung.index') ? 'active' : '' }}">
                <i class="fa-solid fa-users"></i> Quản lý người dùng
            </a></li>
            <li><a href="{{ route('admin.datcho.index') }}" class="{{ request()->routeIs('admin.datcho.index') ? 'active' : '' }}">
                <i class="fa-solid fa-ticket"></i> Quản lý đặt tour
            </a></li>

            <!-- CỘT MỚI: Quản lý khách theo chuyến -->
            <li>
            ...
            <li><a href="{{ route('admin.khuyenmai.index') }}" class="{{ request()->routeIs('admin.khuyenmai.index') ? 'active' : '' }}">
