{{-- resources/views/admin/huongdanvien/create.blade.php --}}
@extends('admin.layouts.dashboard')

@section('content')
<div class="admin-main-container">
    <h3 class="text-center mb-4 fw-bold text-primary">Thêm Hướng Dẫn Viên Mới</h3>
    ...
    <form action="{{ route('admin.huongdanvien.store') }}" method="POST" enctype="multipart/form-data" class="admin-form">
        @csrf
        ...
        <div class="form-actions">
            <button type="submit" class="btn-confirm">Thêm HDV</button>
